...
if __name__ == '__main__':
    ...
    parser.add_argument("--eval_train_aug", default="train_aug", type=str)  # new add
    ...
    parser.add_argument("--cam_eval_thres", default=0.18, type=float)
    parser.add_argument("--cam_scales", default=(1.0, 0.5, 1.5, 2.0),
                        help="Multi-scale inferences")

    # UNS
    parser.add_argument("--uns_network", default="net.resnet50_uns", type=str)
    parser.add_argument("--uns_crop_size", default=512, type=int)
    parser.add_argument("--uns_batch_size", default=16, type=int)
    parser.add_argument("--uns_num_epoches", default=10, type=int)
    parser.add_argument("--eps", default=0.4, type=float)


    # Mining Inter-pixel Relations
    parser.add_argument("--conf_fg_thres", default=0.45, type=float)
    parser.add_argument("--conf_bg_thres", default=0.16, type=float)
    ...
    parser.add_argument("--uns_weights_name", default="sess/res50_uns.pth", type=str)
    ...
    parser.add_argument("--uns_cam_out_dir", default="result/uns_cam", type=str)
    parser.add_argument("--uns_ir_label_out_dir", default="result/uns_ir_label", type=str)
    ...
    parser.add_argument("--train_uns_pass", type=str2bool, default=False)
    parser.add_argument("--make_uns_cam_pass", type=str2bool, default=False)
    parser.add_argument("--eval_uns_cam_pass", type=str2bool, default=False)
    parser.add_argument("--uns_cam_to_ir_label_pass", type=str2bool, default=False)
    ...
    os.makedirs(args.uns_cam_out_dir, exist_ok=True)
    os.makedirs(args.uns_ir_label_out_dir, exist_ok=True)
    ...
    #### UNS training process ####

    if args.train_uns_pass is True:
        import step.train_uns

        timer = pyutils.Timer('step.train_cam:')
        step.train_uns.run(args)


    if args.make_uns_cam_pass is True:
    ...
    if args.uns_cam_to_ir_label_pass is True:
        import step.uns_cam_to_ir_label

        timer = pyutils.Timer('step.cam_to_ir_label:')
        step.uns_cam_to_ir_label.run(args)  
